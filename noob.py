...
def ___metode___():
    ...
    if ___metode___ in ['1','01']:
        ...
        with ThreadPoolExecutor(max_workers=35) as (hayuk):
            for user in ids:
                ...
                if ___password___ in ['1','01']:
                    pwx = [Name.lower, ox[0]+'123', ox[0]+'12345', ox[0]+'121', ox[0]+'1234']]
        ...
        print("\n%s[%s1%s]%s Use Password [Name,Name121,Name123,Name12345,Bangladesh,001122]"%(H,P,H,P))
        print("%s[%s2%s]%s Use Password [Name,Name123,Name1234,786786,Name12345,Name123456, Bangladesh]"%(H,P,H,P))
        ...
        with ThreadPoolExecutor(max_workers=35) as (hayuk):
            for user in ids:
                ...
                if ___password___ in ['1','01']:
                    ...
                    pwx = [Name, ox[0]+'123', ox[0]+'121', ox[0]+'1234', ox[0]+'12345']
